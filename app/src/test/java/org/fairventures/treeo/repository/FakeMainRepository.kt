...
class FakeMainRepository : IMainRepository {
    ...
    override fun createUser(registerUser: RegisterUser): MutableLiveData<NewRegisteredUser> {
    ...
    override fun googleSignUp(googleAuthToken: String): MutableLiveData<GoogleUser> {
    ...
    override fun faceBookSignUp(accessToken: String): MutableLiveData<FacebookUser> {
    ...
    override fun login(loginDetails: LoginDetails): MutableLiveData<LoginToken> {
    ...
    override fun logout(token: String): MutableLiveData<LogoutResponse> {
